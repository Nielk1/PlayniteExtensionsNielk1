...
namespace RobotCacheLibrary
{
    ...
    // Release types we figured out so far
    ...
    // Normal Tag type tags are currently commented out and don't exist in their localization data.
    // This enum is mostly useless given the existance of the data construct from JSON, but it allows us to write code hard-checking some values.
